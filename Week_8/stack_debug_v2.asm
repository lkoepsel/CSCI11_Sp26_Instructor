...
; Debug-level code which performs error checking in stack code
; BEST stack implementation, as application code is cleaner
; Immediately fails and exits on stack full or empty
